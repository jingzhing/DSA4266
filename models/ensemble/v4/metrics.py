...
def find_best_threshold(y_true, probs, metric="balanced_acc", threshold_start=0.05, threshold_end=0.95, threshold_step=0.01):
...
def search_best_weight(y_true, logits_a, logits_b, probs_a, probs_b, search_on="logits", metric="balanced_acc",
                       weight_start=0.0, weight_end=1.0, weight_step=0.01,
                       threshold_start=0.05, threshold_end=0.95, threshold_step=0.01):
